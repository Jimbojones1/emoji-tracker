...
app.shortcut(
  { callback_id: "emojiclicker", type: "message_action" },
          ...
          blocks: [
            {
              ...
              text: {
                type: "mrkdwn",
                text: "###jim  the simplest modal you could conceive of :smile:\n\nMaybe <https://api.slack.com/reference/block-kit/interactive-components|*make the modal interactive*> or <https://api.slack.com/surfaces/modals/using#modifying|*learn more advanced modal use cases*>.",
              },
            },
            {
              type: "context",
...
app.event("reaction_added", async ({ event, client, logger }) => {
  ...
  const peopleInChat = await client.conversations.members({
    channel: event.item.channel,
  });
  console.log(result.messages[0]);
  console.log(peopleInChat.members, " peopel in chat members");
  const userChats = await client.users.profile.get({ user: peopleInChat.members[0] }); 
  console.log(userChats.profile.display_name)
  fetchMessage('C012FKN1GRX', "1670984580.610949");
